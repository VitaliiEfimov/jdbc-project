...
select distinct round(avg(SALARY))
from EMPLOYEES;
...
select *
from EMPLOYEES
group by JOB_ID, EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID;
...
-- salary of 5000 ?
select JOB_ID, min(SALARY), count(MANAGER_ID)
from EMPLOYEES
group by JOB_ID
