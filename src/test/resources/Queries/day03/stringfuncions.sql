...
select FIRST_NAME,substr(FIRST_NAME,0)||'.'||substr(LAST_NAME,0)||'.' as initials from EMPLOYEES;

select FIRST_NAME,substr(FIRST_NAME,0,1)||'.'||substr(LAST_NAME,0,1)||'.' as initials from EMPLOYEES;

select FIRST_NAME,substr(FIRST_NAME,1,1)||'.'||substr(LAST_NAME,1,1)||'.' as initials from EMPLOYEES;

select FIRST_NAME,substr(FIRST_NAME,1,3)||'.'||substr(LAST_NAME,1,3)||'.' as initials from EMPLOYEES;

select FIRST_NAME,substr(FIRST_NAME,3)||'.'||substr(LAST_NAME,3)||'.' as initials from EMPLOYEES;

select FIRST_NAME,substr(FIRST_NAME,3,1)||'.'||substr(LAST_NAME,3,1)||'.' as initials from EMPLOYEES;

select FIRST_NAME,substr(FIRST_NAME,-1,1)||'.'||substr(LAST_NAME,-1,1)||'.' as initials from EMPLOYEES;

select FIRST_NAME,substr(FIRST_NAME,-3,2)||'.'||substr(LAST_NAME,-3,2)||'.' as initials from EMPLOYEES;
